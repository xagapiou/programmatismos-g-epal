...
1. **Παράδειγμα 1: Δημιουργία μεταβλητών**  
...
2. **Παράδειγμα 2: Έλεγχος τύπου δεδομένων**  
...
3. **Παράδειγμα 3: Εγκυρότητα ονομάτων μεταβλητών**  
   Ποια από τα παρακάτω ονόματα μεταβλητών είναι έγκυρα; Δοκιμάστε να τα χρησιμοποιήσετε στον κώδικά σας:
   - `1name`
   - `_name`
   - `name_1`
   - `class`
...
5. **Παράδειγμα 5: Διάκριση πεζών-κεφαλαίων**  
